...
//   };
  ...
  return (
    ...
    />
    <CardMedia
      component="video" // if we have image ehre it will not show video then, we have to mention video 
      height="20%"
      src="./Perfect.mp4"
      controls //without this the video will not play it basically controls the video
      // alt="Paella dish"
    />
    <CardContent>
